  ...
  return (
    <div className="min-h-screen" style={{ backgroundColor: pageBackgroundColor }}>
      {isSplitFirstSection && firstSectionVideo ? (
        <>
        {/* First section: video + title. md:min-h-screen only on desktop; mobile uses content height to avoid cream gap */}
        <section className="flex flex-col md:flex-row md:min-h-screen">
          {/* Left: text — top-aligned on mobile; centered on desktop */}
          <div
            className="md:w-1/2 flex items-start md:items-center px-6 sm:px-8 md:px-12 lg:px-16 pt-6 pb-8 md:py-16 order-2 md:order-1"
            style={{ backgroundColor: firstSectionBgColor ?? "#223c59" }}
          >
            <div className="max-w-2xl">
              <h1 className="text-white text-3xl md:text-4xl lg:text-5xl font-bold mb-3 md:mb-5 leading-snug">
                {splitTitleMain}
        ...
        <section
          className="min-h-screen flex flex-col pt-28 md:pt-36 pb-14 md:pb-20 px-6 sm:px-8 md:pl-8 lg:pl-14 md:pr-12 lg:pr-20"
        ...
        >
          <div className="flex-1 flex flex-col justify-center max-w-6xl mx-auto w-full grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-14 lg:gap-20 items-start">
            <div className="md:col-span-1 ml-0 md:-ml-8 lg:-ml-14">
              <h1
      ...
      {/* ── Intro ── */}
      <section className="bg-[#07090f] py-16 px-6 sm:px-8">
      ...
      {isHowWeHelpSecond ? (
        <section className="flex flex-col py-8 md:py-24 md:min-h-screen px-6 sm:px-8 md:px-0" style={{ backgroundColor: "#fdfbe8" }}>
          <div className="flex-1 flex items-start">
            <div className="w-full grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-24 lg:gap-36 xl:gap-48 items-start">
            {/* Left: headline + paragraphs — mobile inset matches Digital Fusion */}
            <div className="md:col-span-1 flex flex-col justify-start pt-4 md:pt-16 pl-0 md:pl-6 lg:pl-8 space-y-4 md:space-y-5 text-black/90 text-sm md:text-base leading-relaxed">
            ...
            <div className="md:col-span-1 flex flex-col pt-4 md:pt-16 pr-0 md:pr-6 lg:pr-8">
              <h2 className="font-serif text-4xl md:text-5xl lg:text-6xl font-normal text-black leading-[1.15] tracking-tight mb-4 md:mb-14">
                How we help
              </h2>
      ...
      <section className="bg-[#07090f] pb-20 px-6 sm:px-8">
