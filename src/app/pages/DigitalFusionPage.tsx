...
export function DigitalFusionPage() {
  ...
  return (
    <div className="bg-white min-h-screen">
      ...
      <section
        className="pt-24 md:pt-28 pb-0"
        style={{ backgroundColor: "#667f7d" }}
      >
        {/* Left/right columns — horizontal inset on mobile so text doesn’t hug the screen edge */}
        <div className="px-6 sm:px-8 md:pl-0 md:pr-6 lg:pr-10 pb-10 md:pb-14">
          <div className="grid grid-cols-1 md:grid-cols-[55%_45%] gap-6 md:gap-10 items-start w-full">
            <div className="pt-16 md:pt-24 lg:pt-28 pl-0 md:pl-10 lg:pl-14">
            ...
            <div className="mt-8 md:mt-40 lg:mt-56 xl:mt-72 space-y-4 text-[#fdfbe8] text-sm md:text-base leading-relaxed mr-0 md:mr-16 lg:mr-24 xl:mr-32">
      ...
      <section className="min-h-screen flex flex-col py-16 md:py-24 px-6 md:px-12 lg:px-20" style={{ backgroundColor: "#fdfbe8" }}>
        <div className="flex-1 flex flex-col justify-center max-w-6xl mx-auto w-full grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-14 lg:gap-16 items-start">
          ...
          <div className="md:col-span-1 w-full mt-6 md:mt-32 lg:mt-40 xl:mt-48 border-t border-black/30 pt-4 md:pt-0">
