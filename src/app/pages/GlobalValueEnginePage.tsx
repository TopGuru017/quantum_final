...
export function GlobalValueEnginePage() {
  ...
  return (
    <div className="bg-white min-h-screen">
      ...
      <section
        ref={factsRef}
        className="pt-14 md:pt-20 pb-6 md:pb-8 px-6 md:px-12 lg:px-20"
      ...
      <section
        className="min-h-screen flex flex-col pt-8 md:pt-12 pb-16 md:pb-24 px-6 md:px-12 lg:px-20"
        style={{ backgroundColor: "#fdfbe8" }}
      >
        <div className="flex-1 flex flex-col justify-center max-w-6xl mx-auto w-full grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-14 lg:gap-16 items-start">
          <div className="md:col-span-1 flex flex-col justify-center -ml-6 md:-ml-12 lg:-ml-20 pl-6 md:pl-10 lg:pl-14 pt-8 md:pt-10 lg:pt-12">
            <h2 className="font-serif text-4xl md:text-5xl lg:text-6xl font-normal text-black leading-[1.15] tracking-tight">
            Outcomes
            </h2>
          </div>
          <div className="md:col-span-1 w-full mt-6 md:mt-32 lg:mt-40 xl:mt-48">
            <p className="text-black/90 text-sm md:text-base leading-relaxed mb-4 md:mb-10">
