...
export function IndustryAuthorityPage() {
  ...
  return (
    <div className="bg-black min-h-screen">
      ...
      <section className="min-h-screen flex flex-col py-14 md:py-20 px-6 sm:px-8 md:px-12 lg:px-20" style={{ backgroundColor: "#30373b" }}>
        <div className="flex-1 flex flex-col justify-center max-w-6xl mx-auto w-full grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-14 lg:gap-20 items-start">
          {/* Left: half width — large serif title */}
          <div className="md:col-span-1 pt-12 md:pt-28 lg:pt-32">
          ...
          <div className="md:col-span-1 max-w-xl md:max-w-none md:pt-40 lg:pt-52 xl:pt-64 space-y-4 md:space-y-5 text-[#fdfbe8] text-sm md:text-base leading-relaxed">
      ...
      <section className="relative min-h-screen flex flex-col justify-center py-16 px-6 sm:px-8 md:px-6" style={{ backgroundColor: "#fdfbe8" }}>
