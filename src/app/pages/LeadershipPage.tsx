...
import { LEADERSHIP_HERO, LEADER_SANJAY, LEADER_ALOKNATH, LEADER_PIYUSH, LEADER_BIKRAMJIT, LEADER_KURT, LEADER_MIKKO, LEADER_VASTA, LEADER_ROD } from "../assets/images";
...
const leaders = [
  ...
  },
  {
    ...
    name: "Srivatsan (Vatsa) Kalyanasundaram",
    bio: [
  ...
  {
    img: LEADER_ROD,
    role: "Strategic Advisor, Energy & Infrastructure, Sydney",
    name: "Rod Howard",
    bio: [
      "Rod Howard is a highly respected Australian energy-sector executive with 47+ years of leadership across electricity networks, operations, and large-scale infrastructure transformation, including as Deputy CEO and COO of Endeavour Energy.",
      "He serves as Strategic Advisor to utilities, government, and global energy programs, with deep experience in network operations, executive leadership, and regulatory engagement across the energy ecosystem.",
    ],
  },
];
...
export function LeadershipPage() {
  ...
  return (
    <div className="bg-black min-h-screen">
      ...
      {/* ── First section: hero ── */}
      <section className="relative min-h-screen pt-24 md:pt-28 lg:pt-32 pb-16 pl-4 pr-6 md:pl-6 md:pr-12 lg:pl-8 lg:pr-20 overflow-hidden">
        <ImageWithFallback
          src={LEADERSHIP_HERO}
          alt=""
        ...
        <div className="relative z-10 flex flex-col justify-center min-h-[calc(100vh-6rem)]">
          <div className="w-full max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-10 -mt-8 md:-mt-10 lg:-mt-12">
